...
for(var chunkname in pages){
  ...
  var conf = {
    ...
    chunks : ['jquery','react','react-dom','react-router','common', chunkname.substring(chunkname.indexOf('/')+1)],
    minify: { //压缩HTML
        removeComments: true,
...
entryJS['react-router'] = ['react-router'];
...
module.exports = {
    ...
    module: {
        loaders: [//定义一系列加载器
            ...
            {test: /\.(jpg|png)(\?\S*)?$/i, loader: "url?limit=8192&name=img/[name][hash].[ext]"},  //limit=8192表示图片大小单位是k  小于这个值走内联大于这个值走外联             /*images 打包*/
